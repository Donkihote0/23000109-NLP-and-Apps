...
- Nhiệm vụ 4: Mô hình Nâng cao (Embedding học từ đầu + LSTM): Lần này, chúng ta sẽ để mô hình tự học lớp Embedding. Kiến trúc gần như tương tự Nhiệm vụ 3, nhưng Embedding Layer sẽ được học từ đầu.
- Nhiệm vụ 5: Đánh giá, So sánh và Phân tích

### Chạy chương trình: chương trình nằm ở `notebook/lab5_rnns_text_classification.ipynb`, tiến hành chạy từng cell
