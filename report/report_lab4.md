...
### 2. Cách chạy: Tất cả code nằm ở `test/lab4/lab4_test.py`, `test/lab4/lab4_spark_sentiment_analysis.py`, `test/lab4/lab4_improvement_test.py`
...
python test/lab4/lab4_spark_sentiment_analysis.py

# Run the improved model
python test/lab4/lab4_improvement_test.py
```
...
```test/lab4/lab4_spark_sentiment_analysis.py
Loaded 5792 rows, after cleaning: 5791 rows.
25/12/12 12:24:41 WARN InstanceBuilder: Failed to load implementation from:dev.ludovic.netlib.blas.JNIBLAS
...
```test/lab4/lab4_improvement_test.py
Loaded 5792 rows, after cleaning: 5791 rows.

 Training TF-IDF + Logistic Regression
25/12/12 12:26:12 WARN InstanceBuilder: Failed to load implementation from:dev.ludovic.netlib.blas.JNIBLAS
TF-IDF + Logistic Regression Results:
  ➤ Accuracy: 0.7322
  ➤ F1 Score: 0.7306
...
|                                                                            text|label|prediction|                             probability|
+--------------------------------------------------------------------------------+-----+----------+----------------------------------------+
|  ISG An update to our Feb 20th video review..if it closes below 495 much low...|  0.0|       1.0| [0.3798544735885931,0.6201455264114069]|
|  The rodeo clown sent BK screaming into the SI weekly red zone...time to pee...|  0.0|       1.0|[0.33827339663805667,0.6617266033619433]|
|                            , ES,SPY, Ground Hog Week, distribution at highs..  |  0.0|       1.0| [0.3403280338476049,0.6596719661523951]|
|                                                        ES, S  PAT TWO, update  |  0.0|       1.0| [0.3222009759268869,0.6777990240731131]|
|               PCN doulble top at key fib retracement weekly....time to exit ...|  0.0|       1.0| [0.3137586885887565,0.6862413114112436]|
+--------------------------------------------------------------------------------+-----+----------+----------------------------------------+
only showing top 5 rows
...
TF-IDF + Logistic Regression        | Accuracy: 0.7322 | F1: 0.7306
TF-IDF + Naive Bayes                | Accuracy: 0.6907 | F1: 0.6906
Word2Vec + Logistic Regression      | Accuracy: 0.6546 | F1: 0.5796
```
