...
### Các bước trong chương trình: tất cả nằm trong `spark_lab17/src/main/scala/com/donkihote/spark/Lab17_NLPPipeline.scala`

1.  Đặt file dữ liệu vào thư mục `spark_lab17/data/`.
...
8.  Ghi kết quả ra file `results/lab17_pipeline_output.txt` và log vào file log `spark_lab17/log/lab17_log.txt`
...
11. Bổ sung limitDocuments variable để lọc văn bản.
12. Thêm bộ đo cho từng giai đoạn.
13. Thêm Normalizer layer để chuẩn hóa vector.
14. Tìm và hiển thị top K similar documents.
