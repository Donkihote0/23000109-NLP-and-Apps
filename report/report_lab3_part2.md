...
- Tạo file `test/lab3/lab3_test_word_embedding.py` để chạy thử:
...
- Tạo script `test/lab3/lab3_embedding_training_demo.py`.
...
- Tạo file `test/lab3/lab3_spark_word2vec_demo.py`:
...
python test/lab3/lab3_test_word_embedding.py

# Huấn luyện Word2Vec từ đầu
python test/lab3/lab3_embedding_training_demo.py

# Huấn luyện Word2Vec với Apache Spark
python test/lab3/lab3_spark_word2vec_demo.py

# Biểu đồ trực quan hóa
python test/lab3/lab3_visualize_embeddings.py
```
...
### **d. Biểu đồ trực quan hóa**: nằm ở `notebook/output3.png`
